...
model_path = 'test.h5'    ## replace this with your model path
model = models.load_model(model_path, backbone_name='resnet50')
labels_to_names = {0: 'person'}                    ## replace with your model labels and its index value

video_path = 'CV_PS_DT\\input.mp4'  ## replace with input video path
output_path = 'CV_PS_DT\\output.mp4' ## replace with path where you want to save the output
fps = 15
